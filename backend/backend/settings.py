...
# Database Configuration - SQLite by default (no MySQL client installed)
# Set environment variables for MySQL: MYSQL_DATABASE, MYSQL_USER, MYSQL_PASSWORD, MYSQL_HOST
